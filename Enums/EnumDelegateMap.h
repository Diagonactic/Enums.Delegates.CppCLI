...
#define FuncTEnumTReturn Func<TEnum, TReturn>^
...
#define EnumDelegateMapPrivateProperties \
	Dictionary<TEnum, FuncTEnumTReturn>^ s_functionMap = gcnew Dictionary<TEnum, FuncTEnumTReturn>(s_comparer); \
	FuncTEnumTReturn s_default = nullptr;
...
namespace Diagonactic {
	...
	public:
		...
		EnumDelegateMap(FuncTEnumTReturn defaultDelegate) {
			s_default = defaultDelegate;
		}

		/// <summary>Assigns a <paramrf name="delegateFunction"/> to the exact value of <paramref name="value"/></summary>
		...
		void AssignToExactValue(TEnum value, FuncTEnumTReturn delegateFunction) {
		...
		void AssignToEachFlag(TEnum value, FuncTEnumTReturn delegateFunction) {
		...
		TReturn ExecuteExactMatch(TEnum value, FuncTEnumTReturn defaultDelegate) {
